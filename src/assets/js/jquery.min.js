...
;(function (e, undefined) {
      ...
      function kt(e, t, n, i) {
        ...
        if (!i && 1 === f.length) {
          ...
          while (o--) {
            ...
            if (
              (c = r.find[l]) &&
              (i = c(u.matches[0].replace(tt, nt), (X.test(a[0].type) && t.parentNode) || t))
            ) {
  ...
  ;(x.event = {
    ...
    fix: function (e) {
      ...
      return (
        3 === e.target.nodeType && (e.target = e.target.parentNode), s.filter ? s.filter(e, o) : e
      )
    },
    special: {
      load: { noBubble: !0 },
  ...
  function dt(e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        q.hasData(e) &&
        ((o = q.access(e)), (s = x.extend({}, o)), (l = o.events), q.set(t, s), l)
      ) {
    ...
    x.cssHooks[t] = {
      ...
      set: function (e, n, r) {
        ...
        return Ht(
          ...
          n,
          r
            ? Ot(e, t, r, x.support.boxSizing && 'border-box' === x.css(e, 'boxSizing', !1, i), i)
            : 0
        )
      }
    }
